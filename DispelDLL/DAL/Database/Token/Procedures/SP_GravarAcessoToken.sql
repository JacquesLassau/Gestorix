...
BEGIN	
	...
	ELSE
	BEGIN
		Declare @Usuario Int = (Select USUARIO From DB_DISPEL..Token With(nolock) Where STrTOKEN = @StrToken)		
		Update DB_DISPEL..Token Set DATaACESSO = GETUTCDATE() Where STrTOKEN =  @StrToken And USUARIO = @Usuario		
	END
END
GO